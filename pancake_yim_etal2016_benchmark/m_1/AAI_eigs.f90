...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  do kk=1, 1
    ...
    if (kk < 10) then
        write (xx1, '(I0.0)') kk
        open(10, file = 'Ro_10/systemA_'//trim(xx1)//'.mtx', status='old')
    else
        write (xx2, '(I2.0)') kk
        open(10, file = 'Ro_10/systemA_'//trim(xx2)//'.mtx', status='old')
    endif
    print *, kk
  ...
  ! !!! B matrix 
    if (kk < 10) then
        open(10, file = 'Ro_10/systemB_'//trim(xx1)//'.mtx', status='old')
      else
        open(10, file = 'Ro_10/systemB_'//trim(xx2)//'.mtx', status='old')
    endif
    read(10,*)
    read(10,*) n,n,nnz
    allocate(ic(nnz))
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    if (info==0) then
      ...
      if (kk < 10) then
        open(10, file = 'Ro_10/real_eigenvec_'//trim(xx1)//'.dat', status='new')
        open(20, file = 'Ro_10/imag_eigenvec_'//trim(xx1)//'.dat', status='new')
      else
        open(10, file = 'Ro_10/real_eigenvec_'//trim(xx2)//'.dat', status='new')
        open(20, file = 'Ro_10/imag_eigenvec_'//trim(xx2)//'.dat', status='new')
      endif
      do i=1,N
